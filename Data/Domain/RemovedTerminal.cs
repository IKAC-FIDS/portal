...
{
    [Table("psp.RemovedTerminal")]
    public class RemovedTerminal
    {
        ...
        public virtual RemovedMerchantProfile RemovedMerchantProfile { get; set; }
        ...
        public virtual ICollection<RemovedTerminalDocument> TerminalDocuments { get; set; } = new HashSet<RemovedTerminalDocument>();
