...
{
    [Table("psp.RemovedMerchantProfile")]
    public class RemovedMerchantProfile
    {
        ...
        public virtual ICollection<RemovedMerchantProfileDocument> MerchantProfileDocuments { get; set; } = new HashSet<RemovedMerchantProfileDocument>();
        public virtual ICollection<RemovedTerminal> Terminals { get; set; } = new HashSet<RemovedTerminal>();
